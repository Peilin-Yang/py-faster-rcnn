...
class bib(imdb):
    def __init__(self, label, image_set, bib_path=None):
        ...
        self._data_path = self._get_default_path() if bib_path is None \
                            else bib_path
    ...
    def _write_bib_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            ...
            print 'Writing {} Bib results file {}'.format(cls, filename)
    ...
    def _do_python_eval(self, output_dir = 'output'):
        ...
        imagenames = [fn.split('.')[0] for fn in os.listdir(anno_root)]
        annopath = os.path.join(anno_root, '{:s}.xml')
